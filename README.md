...
- трансляция в Телеграм сообщений о подключении/отключении беспроводных клиентов производится скриптом только в случаях, когда:
    - МАС-адрес из строки журнала не имеет соответствующий IP-адрес в DHCP/Leases
    - МАС-адресу из строки журнала назначен динамический IP-адрес
    - МАС-адресу из строки журнала назначен статический IP-адрес в DHCP/Leases, но комментарий к нему отсутствует.
