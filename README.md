...
- контроль работы скрипта доступен через терминал: /system script run tlgrm (где 'tlgrm' - имя скрипта)
...
Вводится и отправляется командау по шаблону: 'имямикротик_имяскрипта - текст с описанием.'
