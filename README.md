...
Скрипт предназначен для трансляции записей журнала устройства в заданную Telegram-группу и удалённого запуска функций, скриптов и команд RouterOS. Работосопособность скрипта проверялась на актуальных версиях RouterOS 6.49.++ и 7.14.++ . 
